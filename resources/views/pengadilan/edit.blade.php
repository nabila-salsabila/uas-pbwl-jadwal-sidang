...
<div class="container">
    <div class="card">
        <div class="card-body">
            <h5 class="card-title">Form Edit Pengadilan</h5>
            <div class="col-sm-8">
                <form class="row g-3 mt-2" action="{{ url('pengadilan/' . $row->id) }}" method="POST">
                    <input type="hidden" name="_method" value="PATCH">
                    @csrf

                    <div class="mb-3">
                        <label for="nama_pengadilan" class="form-label">Nama Pengadilan*</label>
                        <input type="text" class="form-control" id="nama_pengadilan" name="nama_pengadilan" value="{{ $row->nama_pengadilan }}" placeholder="Inputkan Nama Pengadilan..." required>
                    </div>
